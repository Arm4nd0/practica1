<?php
    ...
    class Sesion
    {
        private $User;
        private $Password;
        public function SesionUser($User,$Password)
        {
            $user = $User;
            $psw = $Password;
            if ($user==""or $psw=="")
            {
                $msg="Los campos deberan ir llenos";
            ...
            else
            {
                ...
                if($activo== 0 )
                {
                    $msg='Usuario no activo, consulte con el Administrador';
                    print "<meta http-equiv='refresh' content='0; url=index.php?msg=$msg'>";
                    exit;
                }
                else
        ...
        public function Acceso($ide,$idniv)
        {
            ...
            $base=mysql_select_db('sistemaescolar',$conexion) or die('No existe la base de datos');
